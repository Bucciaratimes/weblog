...
押し込んだ際にブロック外に陣取って、得意の運ぶドリブルからの相手が食い付いたらパスを出すとか、そのまま剥がして空いたところに出すとかできちゃいます。これはまさにリベロなフレンキーの良さを内包しています。もちろんチャンネルに飛び込むとかもできちゃいます（チャンネル侵入後にシュートの選択肢を持てると更にエグくなりそうです）。
...
あと上記画像右下にも書きましたが、アルバをWG化してフレンキー３CB化の選択肢も手に入るのもカッコよくていいなぁと思いました。他にもブスケツをCB間に下げてフレンキ１ピポーテの3-1ビルドアップとかもできますし。

（これをIH起用の時にやるとアタッカーをライン間に入れてSBあげることになると思うんですけどメッシいないし、フレンキーもそのうち前線飛び出すして守備も微妙になるしで微妙ですよね。）

### フレンキー３バック計画の波及効果

フレンキー３バック計画のメリットは、「フレンキーの最適解発見」だけでは終わりません。財政的な危機に陥ってるバルサにとって至れり尽くせりなメリットがあると思うのです。

更にこの計画は「ペドリ、ガビ、ニコ、フレンキーでインテリオールの２席を争うのは滅茶苦茶モッタイナイ問題」を解決できる可能性も秘めているのです。

1. チャビの補強戦略とも合致
2. アルバの後継問題解決の糸口
3. インテリオールだけ人材豊富問題の解決の糸口
...
アルバの後継問題は長年続くバルサの悩みの種の一つですが、フレンキーがRSBのレギュラーになることができれば、今季LSBとして開花しつつあったデストを正式に左に回せるのです。

もちろん右利きのデストが左やるってどうなの？問題は新たに生まれますが、デストのエストレーモ気質的に利き足が内にくる左の方がいい説は確かにあるので、試す価値はあると思います。

また、チーム構造的にも右上がりよりも左上りの方が相性が良いように思います。アンスは純粋なエストレーモとしても十分な強みがありますが、やはり最大の魅力は異次元の決定力だと思います。左上りの陣形はアンスをよりボックス近くに配置可能なのでRSBはバランス型、LSBは攻撃型の方という棲み分けはバルサにあってると思うのです。更にこの棲み分けは、常時スタメンだと微妙だけどピンチヒッター扱いすると強くなる気がする守備型RSBミンゲサも活かすことができるので一石二鳥です。

#### インテリオールだけ人材豊富問題の解決の糸口

現在バルセロナはペドリ、フレンキー、ガビ、ニコという実力者がインテリオールの２枠を争うというリソース的に非常にモッタイナイこと起きてます。正直バルサらしくて気持ち良さもありますが流石にちょっと困ります。

フレンキーを偽サイドバックに置くことで、ペドリ・ガビ・ニコ・（＋まだ見ぬカンテラーノ枠）という形を作ることができ丁度良く回せると思うのです。
...
もちろん、偽サイドバックのデメリットで書いたように１On１万歳な突破力のあるエストレーモが必要なので現状のバルサですぐに再現はできないという問題がありますが、アンスとデンベレ（わんちゃんブライスワイト）が揃い次第とりあえずでいいからやってみて欲しいです。
